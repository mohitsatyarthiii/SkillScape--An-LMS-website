...
const AddCourse = () => {
  ...
  //Function to Add, remove,edit chapters
  const handleChapter = (action, chapterId) => {
    if (action === 'add') {
      ...
      setChapters(
        ...
        chapters.chapterId === chapterId ? { ...chapter, collapsed: !chapter.collapsed } : chapter
      )
      );
    }
  };

  //Function to add lectures button
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full '>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          <div className='flex flex-col gap-1'>
            ...
            className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' min={0} required />
          </div>
        ...
        {/* Adding Chapters & lecutres */}
        <div>{chapters.map((chapter, chapterIndex) => (
        ...
        {showPopup && (
          <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
            <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
              ...
              <button type='button' className='w-full bg-blue-500 text-white px-4 py-2 rounded' onClick={addLecture}>Add</button>
